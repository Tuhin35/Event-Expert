...
import {  getPhotographerSingle } from '../../Service Operations/service';
import { AuthContext } from '../../Contexts/AuthProvider';

const PhotographerDetails = () => {
    const [photographerData, SetPhotographerData] = useState([]);
    const {  pictures, price, rating, agency, _id, category,event} = photographerData
    ...
    useEffect(() => {
        getPhotographerSingle(photographerId)
            .then(data => {
