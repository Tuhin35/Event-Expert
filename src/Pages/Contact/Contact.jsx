                    ...
                    <div className="grid grid-cols-1 gap-6 px-8 text-center md:px-0 md:grid-cols-3">
                        <div className="overflow-hidden bg-white dark:bg-opacity-10 rounded-xl">
                            <div className="p-6">
                                ...
                                <p className="mt-6 text-lg font-medium text-gray-900 dark:text-snow-white-toned">+8801867514649</p>
                                <p className="mt-1 text-lg font-medium text-gray-900 dark:text-snow-white-toned">+8801703873093</p>
                            </div>
                        </div>
                        ...
                        <div className="overflow-hidden bg-white dark:bg-opacity-10 rounded-xl">
                            <div className="p-6">
                                ...
                                <p className="mt-6 text-lg font-medium text-gray-900 dark:text-snow-white-toned" >arriaan59@gmail.com</p>
                                <p className="mt-1 text-lg font-medium text-gray-900 dark:text-snow-white-toned">raihan35-559@diu.edu.bd</p>
                            </div>
                        </div>
