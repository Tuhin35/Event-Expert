                    ...
                    <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                       ...
                       <img className='h-20' src={logo} alt="" />
                        ...
                        <ul className="flex items-center space-x-3 mt-9 dark:text-snow-white-toned">
                            <li>
                                <Link to="" title="" className="flex items-center justify-center  transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-blue-600 focus:bg-blue-600">
                            ...
                            <li>
                                <Link to="https://www.facebook.com/ariaan.tuhin" title="" className="flex items-center justify-center  transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-blue-600 focus:bg-blue-600">
                                    <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <li>
                                <Link to="https://www.instagram.com/raihan_tuhin/" title="" className="flex items-center justify-center  transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-blue-600 focus:bg-blue-600">
                                    <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <li>
                                <Link to="https://github.com/Tuhin35" title="" className="flex items-center justify-center  transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-blue-600 focus:bg-blue-600">
                                    <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                        <path
                                            fill-rule="evenodd"
                                            clip-rule="evenodd"
